...
export const Route = createFileRoute('/about')({
  head: () => ({
    meta: [
      ...
      {
        name: 'description',
        content: 'About jaipkg and the open-source stack that powers it.',
      },
    ],
  }),
  component: About,
...
const TechTile = ({ tech }: TechTileProps) => (
  <a
    ...
    className="group border-bd bg-card hover:border-acc shadow-card relative flex flex-col items-center gap-3.5 rounded-[14px] border px-4 py-7 transition-colors"
  >
